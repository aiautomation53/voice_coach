...
const ensureVapiScript = () => {
  if (!document.querySelector('script[src="https://unpkg.com/@vapi-ai/client-sdk-react/dist/embed/widget.umd.js"]')) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-secondary/20 to-accent-lighter/10">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-start pl-0">
            <vapi-widget style={{ position: 'fixed', top: '100px', left: '100px' }}              public-key="20234fe3-f02a-4cd7-9cf3-addcf5935775"
