  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-accent text-primary-foreground hover:shadow-glow hover:scale-[1.02] active:scale-[0.98] font-semibold",
        primary: "bg-primary text-primary-foreground hover:bg-primary-light hover:shadow-medium",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 border border-card-border",
        outline: "border border-card-border bg-card text-card-foreground hover:bg-secondary hover:shadow-soft",
